...
- Feature: `features/login-navigation.feature`
- Steps: `features/step-definitions/login-navigation.steps.ts`
- Hooks/world: `features/support/hooks.ts`, `features/support/world.ts`
...
1. Show the plain-English scenario in `features/login-navigation.feature`.
